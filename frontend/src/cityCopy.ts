export const cityCopy = {
  ru: {
    ...
    eyebrow: 'ВАШ ГОРОД ВОЗМОЖНОСТЕЙ', headline: 'Знания сегодня —', subline: 'больше возможностей завтра', continue: 'Продолжить обучение', how: 'Мой карьерный путь',
    buildings: 'навыков в городе', completed: 'занятий завершено', available: 'рекомендаций', progress: 'Ваш прогресс', target: 'Следующая цель', current: 'Следующий шаг', all: 'Смотреть все', ai: 'Рекомендации от AI', recent: 'Последние достижения', empty: 'Первые достижения ещё впереди',
  ...
  kk: {
    ...
    eyebrow: 'СЕНІҢ МҮМКІНДІКТЕР ҚАЛАҢ', headline: 'Бүгінгі білім —', subline: 'ертеңгі мол мүмкіндік', continue: 'Оқуды жалғастыру', how: 'Менің мансап жолым',
    buildings: 'қаладағы дағдылар', completed: 'сабақ аяқталды', available: 'ұсыныс', progress: 'Сіздің прогресіңіз', target: 'Келесі мақсат', current: 'Келесі қадам', all: 'Барлығын көру', ai: 'AI ұсыныстары', recent: 'Соңғы жетістіктер', empty: 'Алғашқы жетістіктер әлі алда',
  ...
  en: {
    ...
    eyebrow: 'YOUR CITY OF OPPORTUNITIES', headline: 'Knowledge today.', subline: 'More possibilities tomorrow.', continue: 'Continue learning', how: 'My career path',
    buildings: 'skills in your city', completed: 'activities completed', available: 'recommendations', progress: 'Your progress', target: 'Next goal', current: 'Your next step', all: 'View all', ai: 'AI recommendations', recent: 'Latest achievements', empty: 'Your first achievements are ahead',
    banner: 'Career growth is a path you build yourself.', support: 'And we are here to support you.', explore: 'Explore recommendations', noResults: 'No results for your search', level: 'LEVEL', details: 'View details',
  },
}
