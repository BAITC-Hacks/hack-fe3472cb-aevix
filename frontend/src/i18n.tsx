...
const dict = {
  ru: {
    ...
    no_recs: 'Пока нет подходящих рекомендаций для вашей цели.',
    priority_high: 'Высокий приоритет',
    priority_medium: 'Средний приоритет',
    priority_low: 'Низкий приоритет',
    after: 'после',
    loading: 'Загрузка…',
    error_backend: 'Не удалось загрузить данные. Попробуйте ещё раз.',
    retry: 'Повторить',
  ...
  kk: {
    ...
    no_recs: 'Мақсатыңызға сәйкес ұсыныстар әзірге жоқ.',
    priority_high: 'Жоғары басымдық',
    priority_medium: 'Орташа басымдық',
    priority_low: 'Төмен басымдық',
    after: 'кейін',
    loading: 'Жүктелуде…',
    error_backend: 'Деректерді жүктеу мүмкін болмады. Қайта көріңіз.',
    retry: 'Қайталау',
  ...
  en: {
    ...
    no_recs: 'No suitable recommendations for your goal yet.',
    priority_high: 'High priority',
    priority_medium: 'Medium priority',
    priority_low: 'Low priority',
    after: 'after',
    loading: 'Loading…',
    error_backend: 'We couldn’t load your data. Please try again.',
    retry: 'Retry',
